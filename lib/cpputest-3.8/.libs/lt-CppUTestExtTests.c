...
/* ./.libs/lt-CppUTestExtTests.c - temporary wrapper executable for .libs/CppUTestExtTests
   Generated by libtool (GNU libtool) 2.4.6

   The CppUTestExtTests program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "CppUTestExtTests"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# CppUTestExtTests - temporary wrapper script for .libs/CppUTestExtTests\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The CppUTestExtTests program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"CppUTestExtTests:CppUTestExtTests:$LINENO: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"CppUTestExtTests:CppUTestExtTests:$LINENO: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"CppUTestExtTests:CppUTestExtTests:$LINENO: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='CppUTestExtTests'\n", f);
