...
${OBJECTDIR}/src/LabelDriver.o: src/LabelDriver.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LabelDriver.o src/LabelDriver.cpp
...
${OBJECTDIR}/src/LabelDriver_nomain.o: ${OBJECTDIR}/src/LabelDriver.o src/LabelDriver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LabelDriver_nomain.o src/LabelDriver.cpp;\
	else  \
