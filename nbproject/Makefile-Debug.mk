...
${OBJECTDIR}/_ext/c59b28c3/StorageManagement.o: /home/nick/NetBeansProjects/utest/StorageManagement.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c59b28c3/StorageManagement.o /home/nick/NetBeansProjects/utest/StorageManagement.cpp

${OBJECTDIR}/ConfigFactory.o: ConfigFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigFactory.o ConfigFactory.cpp

${OBJECTDIR}/ModuleEntity.o: ModuleEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleEntity.o ModuleEntity.cpp

${OBJECTDIR}/ModuleServer.o: ModuleServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleServer.o ModuleServer.cpp
...
${TESTDIR}/_ext/80c25dd5/newtestclass.o: /home/nick/NetBeansProjects/utest/tests/newtestclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/80c25dd5/newtestclass.o /home/nick/NetBeansProjects/utest/tests/newtestclass.cpp


${TESTDIR}/_ext/80c25dd5/newtestrunner.o: /home/nick/NetBeansProjects/utest/tests/newtestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/80c25dd5
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/80c25dd5/newtestrunner.o /home/nick/NetBeansProjects/utest/tests/newtestrunner.cpp
...
${OBJECTDIR}/_ext/c59b28c3/StorageManagement_nomain.o: ${OBJECTDIR}/_ext/c59b28c3/StorageManagement.o /home/nick/NetBeansProjects/utest/StorageManagement.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c59b28c3/StorageManagement_nomain.o /home/nick/NetBeansProjects/utest/StorageManagement.cpp;\
	else  \
...
${OBJECTDIR}/ConfigFactory_nomain.o: ${OBJECTDIR}/ConfigFactory.o ConfigFactory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigFactory_nomain.o ConfigFactory.cpp;\
	else  \
...
${OBJECTDIR}/ModuleEntity_nomain.o: ${OBJECTDIR}/ModuleEntity.o ModuleEntity.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleEntity_nomain.o ModuleEntity.cpp;\
	else  \
...
${OBJECTDIR}/ModuleServer_nomain.o: ${OBJECTDIR}/ModuleServer.o ModuleServer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/usr/include/cppunit -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleServer_nomain.o ModuleServer.cpp;\
	else  \
